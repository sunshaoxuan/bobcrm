...
- [x] 批量 ID 解析
- [x] 不存在 ID 处理
- [ ] 缓存行为（当前 LookupResolveService 未实现缓存，后续如引入再补）
...
| 1.4 | 2025-12-28 | 完成 P3-001/P3-002/P3-003：新增 S3FileStorageServiceTests、LookupResolveServiceTests、HealthCheckTests（覆盖文件存储、Lookup 解析、健康检查） |
