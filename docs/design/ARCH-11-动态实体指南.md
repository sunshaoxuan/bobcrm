...
```bash
POST /api/dynamic-entities/BobCrm.Domain.Custom.Product
Content-Type: application/json
...
```bash
POST /api/dynamic-entities/BobCrm.Domain.Custom.Product/query
Content-Type: application/json
...
```bash
PUT /api/dynamic-entities/BobCrm.Domain.Custom.Product/1
Content-Type: application/json
...
```bash
DELETE /api/dynamic-entities/BobCrm.Domain.Custom.Product/1
```
...
```json
{
  ...
  "entities": [
    "BobCrm.Domain.Custom.Product",
    "BobCrm.Domain.Custom.Order",
    "BobCrm.Domain.Custom.OrderItem"
  ]
}
```
...
```bash
GET /api/entity-definitions/type-info/BobCrm.Domain.Custom.Product
```

响应：
```json
{
  "fullName": "BobCrm.Domain.Custom.Product",
  "name": "Product",
  "namespace": "BobCrm.Domain.Custom",
  "isLoaded": true,
  "properties": [
