...
public class I18nService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Fallbacks = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["INTERFACE_ORGANIZATION_DESC"] = new() { ["zh"] = "IOrganizational - OrganizationId/Code/PathCode", ["ja"] = "IOrganizational - OrganizationId/Code/PathCode", ["en"] = "IOrganizational - OrganizationId/Code/PathCode" },
        ["LBL_INTERFACE_ORGANIZATION"] = new() { ["zh"] = "Organization (IOrganizational - 组织维度)", ["ja"] = "Organization (IOrganizational - 組織ディメンション)", ["en"] = "Organization (IOrganizational - organization dimension)" },
