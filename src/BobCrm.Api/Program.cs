...
builder.Services.AddSingleton<II18nService, DefaultI18nService>();
...
builder.Services.AddScoped<BobCrm.Application.Templates.IDefaultTemplateGenerator, BobCrm.Api.Services.DefaultTemplateGenerator>();
