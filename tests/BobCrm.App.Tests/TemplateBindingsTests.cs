...
public class TemplateBindingsTests : TestContext
{
    ...
    {
        public List<(string EntityType, TemplateUsageType UsageType, int? TemplateId, string? ViewState, Guid? MenuNodeId, int? EntityId)> Requests { get; } = new();
        ...
        {
            Requests.Add((entityType, usageType, templateId, viewState, menuNodeId, entityId));
