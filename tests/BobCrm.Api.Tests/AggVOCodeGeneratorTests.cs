...

{
...

    {
        ...
        var entity = CreateTestEntity("Order", "BobCrm.Base.Orders", new[]
        ...
        Assert.Contains("namespace BobCrm.Base.Orders", code);
...

    {
        ...
        var master = CreateTestEntity("Order", "BobCrm.Base.Orders", new[]
        ...
        var detail = CreateTestEntity("OrderLine", "BobCrm.Base.Orders", new[]
...

    {
        ...
        var orderLine = CreateTestEntity("OrderLine", "BobCrm.Base.Orders", new[]
        ...
        var orderComment = CreateTestEntity("OrderComment", "BobCrm.Base.Orders", new[]
...

    {
        ...
        var grandchild = CreateTestEntity("OrderLineAttribute", "BobCrm.Base.Orders", new[]
...

    {
        ...
        var entity = CreateTestEntity("Product", "BobCrm.Base.Products", new[]
...

    {
        ...
        var entity = CreateTestEntity("Customer", "BobCrm.Base.Customers", new[]
