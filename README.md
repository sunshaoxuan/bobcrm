...
## 📝 最新更新（v0.5.4，2025-11-06）

- ✅ **个人中心页面** - 用户信息展示、密码修改功能、头像显示
- ✅ **右上角用户区域改进** - 头像+用户名（可点击）、动态显示登录/退出按钮
- ✅ **表单设计器容器重构** - 属性面板组件化、容器渲染差异化、拖放支持
- ✅ **测试覆盖率大幅提升** - 从67个增至104个测试（**+55%**），核心业务逻辑100%覆盖
- ✅ **测试覆盖率报告** - 详细的覆盖情况分析文档（15个测试文件索引）

详见：[CHANGELOG.md](CHANGELOG.md) | [测试覆盖率报告](docs/测试覆盖率报告.md)
